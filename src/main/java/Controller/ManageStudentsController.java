...
public class ManageStudentsController implements Initializable {
    ...
    private void loadStudentData() {
        // Lấy danh sách sinh viên (giả sử vai trò của sinh viên là "Sinh viên")
                ...
                return new TableCell<User, Void>() {
...

                    {
                        ...
                        btnChangePassword.setOnAction((ActionEvent event) -> {
                            ...
                            // Tạo dialog để nhập mật khẩu mới và xác nhận mật khẩu
                            Dialog<Pair<String, String>> dialog = new Dialog<>();
                            dialog.setTitle("Đổi mật khẩu");
                            dialog.setHeaderText("Nhập mật khẩu mới cho sinh viên: " + student.getUsername());

                            // Thêm các button "Đổi mật khẩu" và "Hủy"
                            ButtonType changeButtonType = new ButtonType("Đổi mật khẩu", ButtonBar.ButtonData.OK_DONE);
                            dialog.getDialogPane().getButtonTypes().addAll(changeButtonType, ButtonType.CANCEL);

                            // Tạo GridPane chứa các trường nhập mật khẩu
                            ...
                            // Khi nhấn nút "Đổi mật khẩu", trả về cặp giá trị từ các trường nhập
                            ...
                            result.ifPresent(passwords -> {
                                ...
                                // Kiểm tra mật khẩu không rỗng và hai ô nhập phải khớp nhau
                                if (newPassword.trim().isEmpty()) {
                                    ...
                                    boolean updated = UserStore.updatePassword(student, newPassword);
                                    if (updated) {
                                        showAlert(Alert.AlertType.INFORMATION, "Đổi mật khẩu", "Đổi mật khẩu thành công cho sinh viên " + student.getUsername());
                                    } else {
