...
public class HistoryPracticeAttemptController {
    ...
    public void setPractice(Practice practice) {
        ...
        lblPracticeName.setText("Lịch sử làm bài: " + practice.getName());
        loadAttempts();
    }
    ...
    private void loadAttempts() {
        ...
        List<Attempt> attempts = AttemptStore.getAllAttempts().stream()
                .filter(a -> a.getPracticeId().equalsIgnoreCase(currentPractice.getPracticeId()))
